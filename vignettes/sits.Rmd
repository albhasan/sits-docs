...
timeline <- scan(time_file, character())

# create a raster metadata file based on the information about the files
raster_cube <- sits_cube(type = "RASTER",
                   satellite = "TERRA",
                   sensor  = "MODIS",
                   name = "Sinop",
                   timeline = timeline,
...
# select NDVI band
samples_ndvi.tb <- sits_select(samples_mt_4bands, "ndvi")
...
point_4bands <- sits_select(point_mt_6bands, c("ndvi", "evi", "nir", "mir"))
...
mato_grosso_2bands  <- sits_select(mato_grosso_samples, c("ndvi", "evi"))
